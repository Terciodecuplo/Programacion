...
public class Morse {
    ...
    private void executeProgram() {
        ...
        do {
            clearConsole(osName);
            showHeader();
            numberToConvert = Integer.parseInt(askForANumberToConvert());
            morseNumber = convierteEnMorse(numberToConvert);
            ...
            userWantsToContinue = getUserInput().toLowerCase().charAt(0);
